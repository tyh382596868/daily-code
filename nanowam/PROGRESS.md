...
- [ ] User: `pip install` 依赖(diffusers, transformers, accelerate, einops, opencv-python, torchvision)
- [ ] User: 从 HF 下载 `Wan-AI/Wan2.1-T2V-1.3B`(snapshot_download),记本地路径填进 `nanowam/configs/wan21_1_3B.yaml`
