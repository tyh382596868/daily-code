...
| Date | Title | Repo |
|------|-------|------|
| 2026-06-05 | [APG: split the CFG update into parallel + orthogonal, shrink only the parallel one](../2026/06/2026-06-05-diffusers-apg-projected-guidance.md) | huggingface/diffusers |
