...
|------|-----------|-------|------|
| 2026-06-08 | VAE up/down sample (cross-repo variant) | [Upsample 8× with zero learnable params: Open-Sora's 3D pixel-shuffle](../nano/wam/2026-06-08-open-sora-pixel-shuffle-3d.md) | [hpcaitech/Open-Sora](https://github.com/hpcaitech/Open-Sora) |
