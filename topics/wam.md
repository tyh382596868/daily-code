...
|------|-----------|-------|------|
| 2026-06-07 | dit-block (MM-DiT dual-stream variant) | [Flux / SD3's dual-stream DiT block: image and text get their own QKV, meet only at attention](../nano/wam/2026-06-07-open-sora-mmdit-double-stream.md) | [hpcaitech/Open-Sora](https://github.com/hpcaitech/Open-Sora) |
