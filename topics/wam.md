...
|------|-----------|-------|------|
| 2026-06-02 | DiT block variant (MMDiT double-stream) | [MMDiT double-stream: image and text share one attention but never share weights](../nano/wam/2026-06-02-open-sora-mmdit-double-stream.md) | [hpcaitech/Open-Sora](https://github.com/hpcaitech/Open-Sora) |
