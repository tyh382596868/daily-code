...
|------|-----------|-------|------|
| 2026-06-08 | vision encoder (patch embed + ViT) | [One Conv2d turns pixels into tokens: nanoVLM's vision encoder](../nano/vla/2026-06-08-nanovlm-vit-patch-embed.md) | [huggingface/nanoVLM](https://github.com/huggingface/nanoVLM) |
