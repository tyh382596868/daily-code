...
|------|-----------|-------|------|
| 2026-06-03 | vision encoder (weight bootstrap from SigLIP) | [Loading SigLIP's pretrained weights into your own fused-QKV ViT](../nano/vla/2026-06-03-nanovlm-vit-from-pretrained.md) | [huggingface/nanoVLM](https://github.com/huggingface/nanoVLM) |
