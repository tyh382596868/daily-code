...
|------|-----------|-------|------|
| 2026-06-02 | vision encoder (patch embed) | [ViTPatchEmbeddings: one Conv2d is the entire ViT entry point (37 lines)](../nano/vla/2026-06-02-nanovlm-vit-patch-embeddings.md) | [huggingface/nanoVLM](https://github.com/huggingface/nanoVLM) |
