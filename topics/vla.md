...
|------|-----------|-------|------|
| 2026-06-07 | vision-encoder | [One Conv2d with stride = patch size: the entire entry point of a VLA's vision encoder](../nano/vla/2026-06-07-nanovlm-vit-patch-embeddings.md) | [huggingface/nanoVLM](https://github.com/huggingface/nanoVLM) |
