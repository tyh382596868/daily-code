...
| Date | Title | File |
|------|-------|------|
| 2026-06-03 | [PyTorch's new `varlen_attn` brings paged KV-cache, GQA and split-KV into core attention](../2026/06/2026-06-03-pytorch-varlen-attn-paged.md) | `torch/nn/attention/varlen.py` |
